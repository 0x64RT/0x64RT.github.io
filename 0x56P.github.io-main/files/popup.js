// Event listener for the popup closure
    ...
    function popup13() {
CreativaPopup.create('Feel free to contact me on Discord <font class="contactding" onclick="allahm109kd(); allahm109kd2();" color="#FF0000">0x64RT</font> :)<br> <font style="color: #696969; font-size: smaller;"> or join my discord server for the best cheese <a href="https://discord.gg/" style="color: #ADD8E6;">https://discord.gg/x343zGXZfj</a> </font>', 'Discord', '', { titleColor: '#6ffcff', textColor: '#b0b0b0' });

    }

    function allahm109kd() {
        navigator.clipboard.writeText("0x64RT");
        setTimeout(function(){
